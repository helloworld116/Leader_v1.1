...
//    [self parentViewController:loginViewController animated:YES completion:nil];
...
- (IBAction)didClickOnButton2:(id)sender{
    RKLoginViewController * loginViewController = [[RKLoginViewController alloc] init];
    loginViewController.modalTransitionStyle = UIModalTransitionStyleCoverVertical;
    [[UIApplication sharedApplication].keyWindow.rootViewController addChildViewController:loginViewController];
//    [self.navigationController parentViewController:loginViewController animated:YES completion:nil];
}
